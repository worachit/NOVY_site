...
urlpatterns = [
    ...
    path('download/api/drone-01/thumbnail/<str:name>', views.drone01_image_thumbnail, name="image_thumbnail"),
    ...
    path('download/api/Marvic-15m/thumbnail/<str:name>', views.Marvic_image_thumbnail, name="image_thumbnail"),
